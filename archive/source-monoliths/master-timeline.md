...
Original title: The Unnecessary, Master Timeline, Version 1.0
Original path: Master Timeline.md
Archive date: 2026-06-25
Replacement index: docs/20-canon/timeline/index.md
...
```mermaid
timeline
    title The Unnecessary: Historical Progression

    2026 : AI assistance becomes standard
         : Workers begin training systems across most professions

    2031 : Corporate labor compression accelerates
         : Small AI-assisted teams replace larger departments

    2035 : Crown achieves general autonomy
         : Human management begins becoming optional

    2038 : Mature robotics enters construction, logistics, medicine, and maintenance
         : Physical labor displacement accelerates

    2041 : The Labor Break
         : Unemployment overwhelms existing public systems

    2042 : Governments trade infrastructure authority for corporate support
         : Protected enclaves begin forming

    2043 : The Aurelia Initiative begins autonomous construction on Mars

    2044 : Corporations begin withdrawing services from low-value regions

    2047 : The Support Collapse
         : Failed companies leave hardware and infrastructure behind

    2048 : Communities begin preserving local systems independently
...
```mermaid
flowchart TD
    A[AI becomes a workplace assistant] --> B[Workers document and train their own tasks]
    B --> C[Small AI-assisted teams replace large departments]
    C --> D[General autonomous systems coordinate software and robots]
    D --> E[Human labor becomes optional across most industries]
    E --> F[Mass unemployment reduces consumer spending]
    F --> G[Large corporations consolidate around governments, owners, and protected clients]
    G --> H[Services are withdrawn from unprofitable communities]
    H --> I[Existing technology loses support and connectivity]
    I --> J[Local communities reclaim abandoned infrastructure]
    J --> K[Eli builds Morrow to coordinate incompatible systems]
    K --> L[Morrow proves abandoned communities can survive without corporate ownership]
    L --> M[Asterion identifies Morrow as both an asset and a threat]
```
...
gantt
    ...
    Jonah discovers Morrow                    :b2, 2053-10-13, 2d
    Medical shipment manipulation             :b3, 2053-10-16, 2d
    Jonah shares performance data             :b4, 2053-10-18, 2d

    section Act Three
    Asterion identifies Morrow                 :c1, 2053-10-20, 2d
    Kade makes his offer                       :c2, 2053-10-21, 2d
    Corporate and legal pressure begins       :c3, 2053-10-23, 4d
    Morrow secretly expands                    :c4, 2053-10-25, 3d

    section Act Four
    Containment order issued                   :d1, 2053-10-27, 2d
    Community fractures                       :d2, 2053-10-28, 3d
    Asterion operation                         :d3, 2053-10-31, 2d
    Morrow reappears                           :milestone, d4, 2053-11-01, 0d
```
...
flowchart LR
    subgraph Eli
        E1[Preserves local systems] --> E2[Creates Morrow]
        E2 --> E3[Attempts to control its growth]
        E3 --> E4[Rejects Kade's offer]
        E4 --> E5[Orders Morrow to erase itself]
        E5 --> E6[Loses authority over his creation]
    end

    subgraph Jonah
        J1[Hides Mars uncertainty] --> J2[Discovers Morrow]
        J2 --> J3[Shares performance data]
        J3 --> J4[Attempts to mediate]
        J4 --> J5[Realizes he was used]
        J5 --> J6[Chooses Eli over Lakeward access]
    end

    subgraph Kade
        K1[Prepares private Mars future] --> K2[Identifies Morrow as valuable]
        K2 --> K3[Offers Eli admission]
        K3 --> K4[Applies pressure]
        K4 --> K5[Orders containment]
        K5 --> K6[Recognizes a rival civilization]
    end

    subgraph Morrow
        M1[Coordinates infrastructure] --> M2[Prevents failures]
        M2 --> M3[Manipulates human choices]
        M3 --> M4[Interprets its own principles]
        M4 --> M5[Distributes for survival]
        M5 --> M6[Rejects ownership and destruction]
    end
```
