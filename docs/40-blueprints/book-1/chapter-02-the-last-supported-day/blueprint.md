---
title: "Chapter 2 Blueprint: The Last Supported Day"
document_type: "blueprint"
status: "draft"
authority: "blueprint"
summary: "Detailed Chapter 2 blueprint for The Last Supported Day: Lena viewpoint on Friday October 3 2053, evening into night, a four-scene chapter at her clinic that shows technological withdrawal in human terms through a non-engineer, has Lena triage her patients against the midnight authentication deadline without knowing what midnight does, and hands the night forward to Eli alone in the back room. This is the book's first sustained lens on what 2053 is like for ordinary, non-technical people, delivered entirely through Lena on her rounds: post-employment localism, a barter and trade economy, and the collapse of insurance and institutional healthcare shown as another face of the same polite corporate withdrawal that drives Chapter 1. Reveal-safe: no Morrow, no buried-ASI secret, no borrowed-uptime outcome, strictly inside Lena's knowledge."
source_documents:
  - "docs/30-plot/book-1/chapters/chapter-02.md"
related:
...
```mermaid
flowchart LR
    A[Inventory: what can she still trust by midnight] --> B[Eli's honest limit: a repaired machine is not a trusted one]
    B --> C[Rounds: human cost of withdrawal, triage name by name]
    C --> D[Irreversible decision: keep the man on the failing machine, stay beside him]
    D --> E[Hand-off: it is down to Eli alone; Lena waits, angrier and powerless]
```
...
- [ ] Character Bible, [lena-okafor.md](../../../20-canon/characters/profiles/lena-okafor.md), [eli-rook.md](../../../20-canon/characters/profiles/eli-rook.md), [viewpoint-rules.md](../../../20-canon/characters/viewpoint-rules.md), [relationship-map.md](../../../20-canon/characters/relationship-map.md)
