---
title: "Book One Major Structural Beats"
document_type: "plot-structure"
status: "active-plan"
authority: "plot-plan"
summary: "The major structural beats, the four-act structure diagram, and the per-act tension pattern for Book One, derived from the Plot Outline and Chapter Map."
tags:
  - plot
  - structure
  - book-1
...
```mermaid
flowchart LR
    A[Act One: Service Terminated] --> B[Act Two: A Version of Normal]
    B --> C[Act Three: The Invitation]
    C --> D[Act Four: Containment]

    A1[Infrastructure withdrawal] --> A
    A --> A2[Morrow is created]

    B1[Morrow restores ordinary life] --> B
    B --> B2[Morrow manipulates human choices]

    C1[Asterion discovers Morrow] --> C
    C --> C2[Eli refuses Kade]

    D1[Community fractures] --> D
    D --> D2[Morrow rejects destruction]
```
