...
status: "draft"
authority: "narration"
summary: "A performance-layer narration script of Chapter 1 that reproduces the approved prose word for word and adds only sparse ElevenLabs v3 audio tags and ellipses to guide a restrained, weary delivery."
tags:
  - narration
  - book-1
  - chapter-01
...
The voice is a warm, steady, grounded storyteller, the kind who has seen a great deal and is in no hurry to tell you about it. Keep the register restrained and weary throughout; the dread in this chapter is administrative and quiet, and the horror lives in the calm flatness of the two corporate notices, which should be read like a form letter, not a threat. Let Eli's interiority stay subdued and Lena's failing-link dialogue stay clipped and consequence-focused. The audio tags are deliberately sparse and color only a few words at a time; trust the sentence shape and the ellipses to carry the rest, and never let earned emotion tip into melodrama. The two emotional peaks are the midday "slow opening of a hand" passage and the final line; everywhere else, lean back.
...
It was the habit of years, not the alarm. Eli's thumb found the glass while the rest of him was still under sleep, and the screen came up gray in the gray morning light, and he read the status bar the way another man might check the weather through a window. The time. The battery, low, the way it always was by morning. And along the top, where the external bars should have stood, ... [quietly] nothing. Only the small notched icon for the local mesh, lit and steady, a single lamp left burning in an empty house.

[slowly] He lay still a moment and looked at it.
...
He had lived through enough of these mornings to take it the way he took a tool that failed in his hand before coffee, [weary] with a small flat patience and no surprise left in it. The mesh was up, which meant the library hub still had power, which meant the neighborhood could talk to itself. It just could not talk to anyone past its own edge.
...
[flat] *Notice of Service Continuity Adjustment.* The provider's name in clean type at the top, the small mark beside it that meant a machine had composed the message with no person anywhere near it. [flat] *Following a periodic review of regional infrastructure, full restoration of cellular service to your area is no longer supported under current service-continuity thresholds. Local connectivity may remain available through community-operated systems. We thank you for your understanding.*

He read it twice.

It was not the towers being down. The towers had been down a hundred times, whenever the grid sagged and the provider shed load to keep the protected zones lit, and they had always come back, sullen and slow, but back. This was different, and the difference was not in the technology. The towers were the same dark towers. The difference was that someone had written it down. [quietly] *No longer supported.* Somewhere, in a building he would never see, a line had been crossed on a spreadsheet, and the number on his side of it had stopped being worth the cost of the people on the other.

There was no error in it to fix, and that was the part his hands kept reaching for and not finding. A dead tower was a problem, and problems had causes and causes had repairs, and he was good at the long quiet work between them. But you could not solder a decision. The thing was working exactly as it was meant to. [slowly] It was simply meant, now, to leave him here.
...
He set the phone face down and reached for his jacket. The notice went into the inside pocket, where it sat against his chest, no heavier than a folded receipt, all morning.
...
[quietly] You had to know where to look.
...
He kept walking, and he kept the map. It kept itself, a tally that ran under everything else. The streetlight on the corner of Webb was dead, had been dead since spring, the glass gone milky. The next one worked. The two after that were dead. He read the lights the way you would read a tide chart, the way they told you where the water had come up to and where it had gone back, block by block, the boundary of what was still being maintained drawn in cold glass over his head.
...
The dairy case along the back wall was dark. Not all of it. The first two doors held milk and the gray tubs of the cultured stuff that kept, a small light burning inside, and the rest of the case stood unlit, the shelves pulled empty and clean, gray as the inside of a switched-off screen. He had seen it half-lit before. He had not seen it down to two doors.

[flat] "Compressor on the long case quit Tuesday," Marisol said, following his eyes, the way you would say it had rained Tuesday. "Nolan looked at it. It's not the compressor. It's the controller wants to call home and nobody's home." She rang up his coffee. [weary] "You want it, I'd take it today. I don't know how long I hold the two."
...
A block from the shop a parked car sat at the curb with a thick orange cable run from a port in its flank across the sidewalk and into the side of a house, taped flat so nobody tripped, the car spending its battery into the home it belonged to. He stepped over it and put the key in the lock and did not look back at the street, which lay behind him quietly insisting it was ordinary, kept ordinary by hands, by people who had stopped some years ago expecting help to come from anywhere but each other.
...
[quietly] "It's fine," Eli told the boy. "That's the problem. It just wants to ask a company that doesn't exist anymore whether it's allowed to ring."
...
"That's what we want," the boy said, with a flatness past his years that Eli recognized and did not comment on. They wanted the house to know there was somebody in it. The wanting reduced down to the thing itself, stripped of every feature the cleverness had wrapped around it, until all that was left was the animal need a doorbell had been invented to answer. [softly] Someone is here. Let me know.
...
He worked through them, and the quiet came over him at the bench the way it always did. There was always another stranded machine to talk down off the ledge of its own obedience, and as long as there was, he did not have to think about being afraid.
...
[slowly] Machines waiting for permission. The whole bench of them, lit and warm and useless, holding their breath for a word that was never coming.
...
"You're fast at that," the man said. "I've watched a few do it. You're faster." A pause, friendly, idle. "Where'd you learn it? You don't pick that up at one of the programs. That's somewhere real. A company. Somewhere with money."
...
The doorbell and the thermostat were the same withdrawal arriving at two different doors. The grocery's dark case and the dead streetlights were the same hand pulling back. The notice in his pocket and the notice on his screen were one event, written down twice, in the same calm voice, by the same kind of decision. Nobody had attacked this place. Everything physical was exactly where it had been, working, ready, waiting, and the only thing that had changed was that a series of companies, each in its own building, had quietly and at the same time decided these people were no longer worth the cost of serving, and had written it down, politely, and moved on. It was not destruction. Destruction would have left a mark. This left nothing. [slowly] This was the slow opening of a hand that had been holding them up, ... finger by finger, ... with a thank-you note for each finger as it let go.

He set the phone down and looked at the crowded bench, the lit machines waiting on their dead servers, and for the first time that morning he did not see a queue of separate jobs. He saw one shape, reaching everything, himself in the middle of it with a screwdriver, fixing the small ends one device at a time while the whole of it kept coming. He thought, against the grain of how he liked to hold the world, about everything else that still worked only because somewhere, someone had not yet decided it wasn't worth it. The list, once he let himself start it, did not have a bottom.
...
He wrote back, *Here. Call,* and pulled the cracked shop screen around on its arm and propped the phone into the cradle that fed the hub's relay, and waited while the mesh did what it could. The link came up thin, the way it always came up thin now, the bandwidth squeezed down to what the local radios could carry without the outside pipes the providers had taken. Her voice when it arrived was narrowed and flattened, dropping a syllable here and there into silence and coming back, a person talking from the bottom of a well.

"Can you hear me," she said.

"Most of it."

[clipped] "I'm going to read you something." No hello. That was Lena. He could hear, under the thin voice, the quiet she got when she was angriest, the quiet that other people mistook for calm. "Came an hour ago. Formal notice. From the manufacturer." A pause, the link swallowing it. [tense] "Three systems. The diagnostic scanner. The medication-management unit. And the respiratory controller. All three lose remote authentication at midnight tonight."
...
[hesitant] "Do you." It was not cruel. It was a real question, the realest she had asked. "I can hear you doing it. You've got it on a bench in your head, scanner, med unit, controller, three problems, sorting them by how hard they are. It's not three problems. It's one decision somebody made in a building, and the bottom of it is a man who can't breathe through the night. [quietly] Stay down here with me. Don't go up where it's clean."

He did not answer right away. He looked at the three names sitting in plain type with a single time beside them, *23:59,* the lives reduced to a threshold and a clock, and the cold came up through the floor of the shop and into him, and it was not all from the room.
...
[quietly] "I know what it is," Lena said quietly. "I've known what it is for a year. I'm asking you what we do about the man tonight."

And here was the place he had been walking toward all morning without letting himself see it, and it stopped him short of nothing now. Because he could see the fix. That was the worst of it. He could see exactly the move that had saved the doorbell and the thermostat and the router, the whole of what he did. When a company died and left a machine stranded, you stood in for the company. You emulated the dead server. You forged the permission the corpse could no longer grant, and the machine, not knowing the difference, ran. He could play a dead server a hundred times over. It was the one true thing he could do against all of this.

But the company was not dead.

That was the wall, and he hit it standing still, and it did not move. The manufacturer of that respiratory controller still existed. It had a building and a name and a machine that wrote calm notices, and it had not gone dark and abandoned its server to the weeds for him to come along and impersonate. It was right there, alive, holding the key, and choosing, this morning, in writing, to close its hand. There was no dead server to stand in for, because the server was not dead. It was being told to stop answering this neighborhood, on purpose, by people still in business who had decided this was good business. He could cut the controller loose the way he had cut the doorbell loose, but a doorbell that runs wrong rings at the wrong time, and a respiratory controller that runs wrong, stripped of the calibration and the safety record the authentication had carried, kills the man it is keeping alive, slowly, correctly, while reporting that everything is fine.

He could not emulate his way past a hand that was still holding the key. There was nothing absent to fill in, only something present, and refusing.

[tense] "Eli," Lena said. "You went quiet. Tell me you didn't go quiet because there's nothing."

He looked at the screen a long moment.

"I'm here. I'm thinking."

It was true and it was not enough and they both knew it. He told her he would come, he would bring what he had, he would look at the controller with his own eyes before he said anything was impossible, because saying a thing was impossible from across a thin link was a coward's certainty and he would not give it to her. She said come tonight, before, not at midnight, and he said tonight, before, and the link thinned and dropped and came back once more with only her voice saying his name as a question, [hesitant] *Eli?,* and then it dropped for good.
...
[slowly] He looked at the three names, and the single time beneath them, and understood, [quietly] fully and without any way back, that this was the one he could not fix.
