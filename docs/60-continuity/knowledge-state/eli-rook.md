...
summary: "Pre-draft knowledge state for Elias Rook at story start, the morning of October 3, 2053, separating what he knows, what he falsely believes, and what he does not yet know."
tags:
  - continuity
  - knowledge-state
  - eli-rook
...
- His neighborhood's service decline is becoming irreversible. The regional cellular provider has stopped serving several towers, and restoration is no longer economically viable.
...
- His secret is Morrow. By the author's ruling, Eli's secret is simply that he secretly created Morrow, a true artificial superintelligence, roughly six years ago and buried it; its very existence is the secret no one knows. He knows it exists, knows where it is (a hidden 128 TB drive labeled "Morrow" inside a dirty old computer at Northglass, the abandoned Asterion campus), and knows he buried it powered-down rather than destroying it because it was his life's work. He has kept its existence secret for years, concealed from everyone including Jonah and Lena.
- The Mosaic principles he carried out of Asterion in his head are background that informed Morrow's build, not the secret itself. He privately reconstructed several restricted Mosaic principles from memory after leaving Asterion and took none of Asterion's code; Morrow is his own separate creation from those principles, which is why Asterion never knew it existed.
...
## What Eli Falsely Believes

- That if he avoids positions of authority, he cannot become like Kade. (Canon false belief: refusing authority does not prevent his decisions from shaping other people's lives.)
- That an intelligence he creates should still obey him because he created it, even while believing powerful intelligence should not be owned. (Canon core contradiction.)
...
- That Jonah already knows the Mercer family is not in the first Mars migration group. (Canon secret: held by Jonah.)
- That June receives protected documentation from her father. (Canon secret: Eli may discover during Book Two.)
- That Lena uses traceable stolen medical credentials. (Canon secret: held by Lena.)
