...
summary: "Enriched profile for the Reyes man, the ward patient whose healing leg is dressed by hand in Chapter 2 of The Unnecessary after the smart-foam supplier stopped supplying. The Reyes place is also a node on Dembele's food board that needs the Vesely eggs. Built under the profile-enrichment spec: full thirteen-section schema, zero blanks, reveal-tagged hidden facts, and every invented load-bearing fact accepted as character canon (Decision 056). Canon facts trace to approved Chapter 2; the given name Hector, his birth date, age, birthplace, household, and physical identifiers are accepted as character canon."
tags:
  - character
  - walk-on
  - community
