---
title: "The Caldwell Girl"
document_type: "character-profile"
status: "active-canon"
authority: "character-canon"
summary: "Enriched draft profile for the Caldwell girl, the feverish child patient kept overnight at Lena Okafor's independent community clinic, established in approved Chapter 2 of The Unnecessary. Built under the profile-enrichment spec: full thirteen-section schema, zero blanks, reveal-tagged hidden facts, every invented load-bearing fact accepted as character canon (Decision 056). A child walk-on watched by hand, not by the machine, and one of the chapter's clearest images of care without certainty. Generated as part of the Riverside clinic cluster so household, ages, and edges cohere with Lena, Priya, Tomas, and Mr. Adeyemi."
tags:
  - character
  - walk-on
  - clinic
