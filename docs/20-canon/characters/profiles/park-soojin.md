...
summary: "Enriched v2 draft profile for Soo-jin Park, June Park's mother, who refused to follow her husband into a protected enclave rather than abandon her own elderly mother, and now holds a three-generation household together in Greater Detroit. Built under the profile-enrichment spec: full thirteen-section schema, zero blanks, reveal-tagged hidden facts, machine-readable plus prose relationships. The only fixed facts are those traced to June Park's active-canon profile. The flavor facts (maiden name Han, age, birth date, birthplace, occupation, physical identifiers, and surface detail) are accepted as character canon under Decision 056. The mother's name Han Young-hee and her details remain the author's to accept or veto. Behavior-only and reveal-tagged items remain author-facing. The profile remains a draft pending author activation and the enrichment is reversible."
tags:
  - character
  - park-family
  - community
...
related:
  ...
  - "../../world/locations/greater-detroit.md"
