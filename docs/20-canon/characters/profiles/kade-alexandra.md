---
title: "Alexandra Kade"
document_type: "character-profile"
status: "active-canon"
authority: "character-canon"
summary: "Enriched profile for Alexandra Kade, Adrian Kade's adult daughter, generated under the profile-enrichment spec as part of the Kade-family cluster. Full thirteen-section schema, zero blanks, reveal-tagged hidden facts; surface-flavor facts are accepted as character canon (Decision 056), and reveal-tagged and behavior-only items remain author-facing. The canon spine is fixed: born June 16, 2021 (age 32 at Book One), works in ecological systems design, has rejected a formal Asterion role, is cordial and distant with her father, and has a Mars place he reserved without asking. Her mother is undefined in canon and is left an open slot, not invented. Her ultimate position on Mars is reserved for later books and is not stated here."
tags:
  - character
  - kade-family
  - gatekeeper-adjacent
...
source_documents:
  ...
  - "docs/30-plot/book-1/chapters/chapter-09.md"
---
...
**Her mother** (OPEN CANONICAL SLOT, not invented). Canon establishes only that Kade's relationship with Alexandra's mother ended several years after 2021 and that Alexandra was then raised across several private residences while spending significant time with her father. `[canon, ../../timeline/historical/2026-2034-assistance-and-compression.md]` The mother's name, lineage, whereabouts, and current relationship to Alexandra are undefined and are deliberately left blank rather than invented. FLAG for the author and for a future canon pass: this is the largest open question in Alexandra's backstory and should be settled before her interior is finalized, because who raised her and where her mother stands shape her ecology and her refusal both.
...
- Her mother is UNDEFINED in canon and is an open slot. Do not treat any invented mother as fixed. FLAG.
