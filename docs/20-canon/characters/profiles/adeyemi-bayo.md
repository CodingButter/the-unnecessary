...
summary: "Enriched draft profile for Mr. Adeyemi, the sixty-one-year-old respiratory patient kept alive overnight by a controller whose maker withdrew remote authentication, established in approved Chapter 2 of The Unnecessary. Built under the profile-enrichment spec: full thirteen-section schema, zero blanks, reveal-tagged hidden facts, every invented load-bearing fact accepted as character canon (Decision 056). A clinic walk-on and the human stake under the chapter's midnight authentication deadline. Generated as part of the Riverside clinic cluster so household, ages, and edges cohere with Lena Okafor, Tomas, Priya, and the Caldwell girl."
tags:
  - character
  - walk-on
  - clinic
