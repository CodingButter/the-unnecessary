...
summary: "Enriched v2 draft profile for Daniel Park, June Park's father, a robotics-maintenance contractor living inside a protected enclave and separated from his family in Greater Detroit. Built under the profile-enrichment spec: full thirteen-section schema, zero blanks, reveal-tagged hidden facts, machine-readable plus prose relationships. The only fixed facts are those traced to June Park's active-canon profile. The flavor facts (Korean given name Hyun-woo, age, birth date, birthplace, physical identifiers, and surface detail) are accepted as character canon under Decision 056. The mother-in-law's name Han Young-hee and her dementia remain the author's to accept or veto. Behavior-only and reveal-tagged items remain author-facing. The profile remains a draft pending author activation and the enrichment is reversible."
tags:
  - character
  - park-family
  - enclave
