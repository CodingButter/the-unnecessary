---
title: "Character Profiles Index"
document_type: "index"
status: "active-support"
authority: "character-canon"
summary: "Indexes the individual character profiles of The Unnecessary, one file per character. Each profile is the single authority for that character's identity, history, voice, secrets, and arc."
tags:
  - index
  - character
  - profiles
...
One file per character. Each profile is the authority for that character. Load only the profiles a scene needs. For the relationship map and the viewpoint and dialogue rules, see the parent [characters index](../index.md).

Read first: the profile of the viewpoint character for the scene you are working on.
...
- Characters domain: [../index.md](../index.md)
