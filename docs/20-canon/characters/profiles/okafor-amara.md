...
summary: "Enriched profile for Amara Okafor, the seventy-four-year-old Nigerian-American mother of Dr. Lena Okafor and the surviving half of the Detroit grocery couple that raised her. Built under the profile-enrichment spec: full thirteen-section schema, zero blanks, reveal-tagged hidden facts, dual machine-readable and prose relationships, and every invented load-bearing fact accepted as character canon (Decision 056). The load-bearing canon (her name, age, Nigerian-American family, and the grocery origin) is fixed by the active-canon okafor-lena.md; she does not yet appear in approved manuscript prose."
tags:
  - character
  - supporting
  - okafor
