...
summary: "Enriched draft profile for Priya, clinic staff at Lena Okafor's independent community clinic who watches the feverish Caldwell girl by hand when the medication cabinet can no longer be trusted, established in approved Chapter 2 of The Unnecessary. Built under the profile-enrichment spec: full thirteen-section schema, zero blanks, reveal-tagged hidden facts, every invented load-bearing fact accepted as character canon (Decision 056). Generated as part of the Riverside clinic cluster so household, ages, and edges cohere with Lena, Mr. Adeyemi, Tomas, and the Caldwell girl."
tags:
  - character
  - walk-on
  - clinic
