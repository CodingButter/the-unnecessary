...
summary: "Enriched profile for Dembélé, the retired logistics man who keeps the neighborhood food-trade board in Chapter 2 of The Unnecessary. He is the named instantiation of the social-structure canon line about a former freight analyst keeping a food board, and the book's clearest figure for skill applied closer to home. Built under the profile-enrichment spec: full thirteen-section schema, zero blanks, reveal-tagged hidden facts. Canon facts trace to approved Chapter 2; the given name Sékou, his birth date, age, birthplace, household, and physical identifiers are accepted as character canon (Decision 056)."
tags:
  - character
  - walk-on
  - community
