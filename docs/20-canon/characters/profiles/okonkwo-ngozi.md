...
summary: "Enriched profile for Mrs. Okonkwo, who pays the clinic in a dozen brown eggs in Chapter 2 of The Unnecessary. She is the human face of the barter fee and a node in the egg ledger that links the Vesely place, Dembélé's board, and Lena's clinic. Built under the profile-enrichment spec: full thirteen-section schema, zero blanks, reveal-tagged hidden facts. Canon facts trace to approved Chapter 2; the given name Ngozi, her birth date, age, birthplace, household, and physical identifiers are accepted as character canon (Decision 056)."
tags:
  - character
  - walk-on
  - community
