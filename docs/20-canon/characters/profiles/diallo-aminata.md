...
summary: "Enriched profile for Mrs. Diallo, the patient in Chapter 2 of The Unnecessary who delayed care for months out of a lifelong dread of a medical bill that no longer exists, and whose cough has become the thing it was always going to be. She is the book's cleanest image of an institution outliving itself as pure fear. Built under the profile-enrichment spec: full thirteen-section schema, zero blanks, reveal-tagged hidden facts, and every invented load-bearing fact accepted as character canon (Decision 056). Canon facts trace to approved Chapter 2; the given name Aminata, her birth date, age, birthplace, household, and physical identifiers are accepted as character canon."
tags:
  - character
  - walk-on
  - community
