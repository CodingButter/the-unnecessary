...
summary: "Enriched profile for the Vesely hen-keeper, the brown-egg source that begins the barter chain in Chapter 2 of The Unnecessary. In approved prose the Vesely place appears only offscreen as the origin of the eggs; Marek is the representative keeper of the smallholding. Built under the profile-enrichment spec: full thirteen-section schema, zero blanks, reveal-tagged hidden facts. The canon fact is the Vesely place and its brown eggs; the individual Marek, his name, age, birthplace, household, and physical identifiers are accepted as character canon (Decision 056)."
tags:
  - character
  - walk-on
  - community
