...
summary: "Enriched draft profile for Tomas, the thirty-year-old night nurse at Lena Okafor's independent community clinic, established in approved Chapter 2 of The Unnecessary. Built under the profile-enrichment spec: full thirteen-section schema, zero blanks, reveal-tagged hidden facts, every invented load-bearing fact accepted as character canon (Decision 056). The steady second pair of hands on the floor and the staffer Lena 'had not had to teach to be afraid quietly.' Generated as part of the Riverside clinic cluster so household, ages, and edges cohere with Lena, Mr. Adeyemi, Priya, and the Caldwell girl."
tags:
  - character
  - walk-on
  - clinic
