...
summary: "Enriched v2 profile for Marisol, the neighborhood grocer in Chapter 1 of The Unnecessary. Built as the cast exemplar under the profile-enrichment spec: full thirteen-section schema, zero blanks, reveal-tagged hidden facts. Invented load-bearing facts are accepted as character canon (Decision 056). Marisol is a minor recurring walk-on and the human barometer of the polite corporate withdrawal, established in approved Chapter 1."
tags:
  - character
  - walk-on
  - community
